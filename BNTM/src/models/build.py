...
from .BNTM import BNTM
from .ViTree_copy import ViTree_copy
...
def build_model(config):
    ...
    elif model_type == 'ViTree':
        model = BNTM(config, 1, 1024)
    
    elif model_type == 'ViTree_copy':
        model = ViTree_copy(config)
    else:
